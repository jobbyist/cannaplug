...
const stories = [
  ...
  {
    label: "Menu",
    title: "Explore the CannaPlug Menu.",
    copy: "A considered selection for every kind of experience.",
    icon: Menu,
    image: categoryImage,
    cta: "View the menu",
  },
  {
    label: "Products",
    title: "Curated cannabis. Premium quality.",
    copy: "Products selected with care, knowledge and high standards.",
    icon: ShoppingBag,
    image: productImage,
    cta: "Shop products",
  },
  {
    label: "Deals",
    title: "Plug into something special.",
    copy: "Limited drops and thoughtful rewards for our community.",
    icon: TicketPercent,
    image: productImage,
    cta: "See the latest",
  },
  {
    ...
    copy: "Meet the people shaping cannabis culture in South Africa.",
    icon: CalendarDays,
  ...
  {
    label: "Newsroom",
    title: "Cannabis culture, decoded.",
    copy: "Useful, informed stories without the noise.",
    icon: Newspaper,
    image: editorialImage,
  ...
  {
    label: "Locations",
    title: "Come visit the Plug.",
    copy: "Shop 002, One On Mutual, Pretoria Central.",
    icon: MapPin,
    image: storeAsset.url,
    cta: "Get directions",
  },
  {
    label: "Contact",
    title: "Come say hello.",
    copy: "Real advice from knowledgeable people who care.",
    icon: Mail,
    image: storeAsset.url,
    cta: "Contact us",
  },
...
const categories = [
  ["Flower", "Premium Strains", "category-pos-1"],
  ["Edibles", "Gourmet Infusions", "category-pos-2"],
  ["Vapes", "Discreet & Smooth", "category-pos-3"],
  ["Concentrates", "Pure Potency", "category-pos-4"],
...
const news = [
  [
    ...
    "The language is familiar. The science is more nuanced. Here’s a clear place to begin.",
    "08 Sep 2026",
    "editorial-pos-1",
  ],
  [
    "Industry",
    "The Rise of Premium Cannabis in South Africa",
    "A closer look at the people, craft and standards shaping a more considered market.",
    "02 Sep 2026",
    "editorial-pos-2",
  ],
  [
    "Wellness",
    "Cannabis & Wellness: A More Informed Conversation",
    "Thoughtful guidance for making responsible, personal and well-informed choices.",
    "28 Aug 2026",
    "editorial-pos-3",
  ],
];
...
const events = [
  [
    "19",
    "SEP",
    "CannaPlug Culture Session",
    "Pretoria Central",
    "An intimate evening of education, music and conversation.",
    "event-one",
  ],
  [
    "04",
    "OCT",
    "Wellness & Cannabis Workshop",
    "Johannesburg",
    "Practical, informed guidance with local wellness practitioners.",
    "event-two",
  ],
  [
    "08",
    "NOV",
    "CannaPlug Community Mixer",
    "Cape Town",
    "Good people, fresh perspectives and a distinctly local energy.",
    "event-three",
  ],
];
...
export function Logo({ inverse = false }: { inverse?: boolean }) {
  return (
    <a href="/#top" aria-label="CannaPlug home" className={inverse ? "logo inverse" : "logo"}>
      <img src={inverse ? logoImageWhite : logoImage} alt="CannaPlug" />
    </a>
  );
}
...
function StoryNavigation() {
  ...
  return (
    <>
      <div className="stories-wrap" aria-label="CannaPlug stories">
        <div className="stories">
          {stories.map((item, i) => (
            <button key={item.label} className="story" onClick={() => setActive(i)}>
          ...
          >
            ...
            <div className="mobile-nav-body">
              <nav className="mobile-nav-primary">
                {primaryLinks.map(([Icon, label, href], index) => (
                  <a
                  ...
                  >
                    <Icon size={20} />
                    <span>{label}</span>
                    {index === 1 && <small>Curated</small>}
                  </a>
                ))}
              </nav>
              <div className="mobile-explore">
                <div className="mobile-explore-title">
                  <span>
                    <Leaf size={20} />
                    Explore
                  </span>
                ...
                <div className="mobile-explore-grid">
                  {exploreLinks.map(([Icon, label, href]) => (
              ...
              <nav className="mobile-nav-secondary">
                ...
                <a href="/account" onClick={onClose}>
                  ...
                  <span>{user ? "Your account" : "Sign in / Join"}</span>
                  <ChevronRight size={17} />
                </a>
              </nav>
            </div>
...
export function Header() {
  ...
  const primaryLinks = [
    [Store, "Home", "/"],
    [ShoppingBag, "Shop products", "/shop"],
    [Menu, "Explore menu", "/#categories"],
      ...
      <header className={compact ? "header compact" : "header"}>
        <div className="header-inner">
          ...
          <div className="header-actions">
            ...
            <a
              className="header-icon-link desktop-icon"
        ...
        {search && (
          <motion.div className="search-panel" initial={{ height: 0 }} animate={{ height: "auto" }}>
            <Search size={18} />
            <input
              autoFocus
              aria-label="Search products"
              placeholder="Search products, stories and events…"
            />
          </motion.div>
        )}
      </header>
  ...
  return (
    <section className="hero" id="top">
      <img
        ...
        src={heroImage}
        alt="Premium CannaPlug cannabis flower and apothecary jar"
        width={1920}
        height={1080}
      />
      ...
      >
        <p className="eyebrow">Premium cannabis dispensary</p>
        <h1>
          QUALITY CANNABIS.
          <br />
          <em>REAL PEOPLE.</em>
        ...
        <p className="hero-lede">
          ...
          <br />A better cannabis experience.
        </p>
      ...
      <div className="trust-row">
        {[
          ...
          [BadgeCheck, "Lab tested"],
          [Truck, "Discreet delivery"],
          [Headphones, "Expert support"],
        ].map(([I, label]) => {
          const C = I as typeof Leaf;
          return (
...
function Categories() {
  return (
    <section className="page-section" id="categories">
      <Reveal>
        <SectionHeading title="SHOP BY CATEGORY" action="View all" />
        <div className="category-grid">
          {categories.map(([name, desc, pos]) => (
...
function Products() {
  ...
  const { add } = useCart();
  return (
    <section className="page-section product-section" id="shop">
      <Reveal>
        <SectionHeading eyebrow="Curated selection" title="FEATURED PRODUCTS" action="Shop all" />
        <div className="product-grid">
          {products.map(([name, cat, price, badge, pos]) => (
              ...
              <div className="product-info">
                ...
                <div>
                  ...
                  <Button
                    ...
                    onClick={() => {
                      add({
                        productId: `featured-${String(name)}`,
                        name: String(name),
...
function CampaignBanner() {
  return (
    <section className="campaign-shell" id="plug-back">
      <Reveal>
        <div className="campaign">
          <div className="campaign-title">
            <p className="eyebrow">Pre-roll tube take-back · Now on</p>
            <h2>
              PLUG
              <br />
              BACK.
            </h2>
            <p>Recycle & get rewarded.</p>
          </div>
          <div className="campaign-copy">
            <div className="bring-get">
              <b>BRING</b>
              <span>
                10 empty <strong>CannaPlug</strong>
                <br />
                pre-roll tubes
              </span>
              <b>GET</b>
              <span>
                1 complimentary
                <br />
                <strong>Greenhouse</strong> pre-roll
              </span>
            </div>
            <h3>
              10 TUBES <i>=</i> 1 FREE
            ...
            <blockquote>
              Less plastic on the streets.
              <br />
              More smoke in your pocket.
            </blockquote>
            <small>In-store only · Original CannaPlug tubes · While stocks last</small>
          </div>
        </div>
      </Reveal>
    </section>
...
function ExperienceSection() {
  const points = [
    [MessageCircle, "Expert guidance", "Real advice. No judgement."],
    [ShieldCheck, "Quality assured", "A carefully selected range."],
    [UsersRound, "Community", "Culture, education and connection."],
    [PackageCheck, "Discretion", "Professional at every touchpoint."],
  ];
  return (
    <section className="experience" id="experience">
      <Reveal className="experience-inner">
        <div className="experience-copy">
          <p className="eyebrow">Good plants. Great people.</p>
          <h2>
            THE CANNA PLUG
            <br />
            <em>EXPERIENCE</em>
          </h2>
          <p>We're more than a dispensary — we're a community.</p>
          <p>
            CannaPlug is built on quality, education and a deep respect for the plant. Whether
            you're exploring cannabis for the first time or you're already a connoisseur, we're here
            to elevate the experience.
          </p>
        </div>
        <div className="principles">
          {points.map(([I, title, copy]) => {
            const C = I as typeof Leaf;
            return (
...
function Events() {
  return (
    <section className="events" id="events">
      <Reveal>
        <SectionHeading
          eyebrow="Good vibes & great people"
          title="UPCOMING EVENTS"
          action="View calendar"
        />
        <div className="event-grid">
          {events.map(([day, month, title, location, copy, style]) => (
            <article className={`event-card ${style}`} key={title}>
              ...
              <div className="event-copy">
                ...
                <span>{copy}</span>
                <a href="/#events">
                  RSVP / View event <ArrowRight size={15} />
                </a>
              </div>
            </article>
          ))}
    ...
    <section className="contact" id="contact">
      <Reveal className="contact-grid">
        <div className="contact-info">
          ...
          <p>Questions, recommendations or a first visit? Speak to our team.</p>
          <ul>
            <li>
              <Phone size={18} />
            ...
            <li>
              <MapPin size={18} />
              <span>Shop 002, One On Mutual, Pretoria Central</span>
            </li>
            <li>
              <Clock3 size={18} />
              <span>Mon–Fri 09:00–19:00 · Sat 09:00–20:00 · Sun 09:00–15:00</span>
            </li>
          </ul>
          <a
            className="direction-link"
            href="https://maps.google.com/?q=One+On+Mutual+Pretoria"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <div className="store-panel">
          <StoreVideo />
          <span>
            <Play size={18} fill="currentColor" /> Visit CannaPlug Pretoria
          </span>
        </div>
...
const footerExploreLinks: [string, string][] = [
  ["Shop", "/shop"],
  ["Menu", "/#categories"],
  ["Events", "/#events"],
  ["Journal", "/journal"],
...
const footerInfoLinks: [string, string][] = [
  ["FAQs", "/faq"],
    ...
    <footer>
      <div className="footer-main">
        <div className="footer-brand">
          ...
          <p>Premium cannabis, curated with care in Pretoria.</p>
        </div>
        <div>
          <h3>Explore</h3>
        ...
        <div>
          <h3>Information</h3>
          {footerInfoLinks.map(([label, href]) => (
            <a href={href} key={label}>
              {label}
            </a>
          ))}
      ...
      <div className="footer-bottom">
        <span>18+ · Consume responsibly</span>
        <span>
          Licensed Medical Cannabis Dispensary · SAHPRA Section 21 Authorised · Registration No.
          2026/047873/07
        </span>
        <span>© 2026 CannaPlug™</span>
      </div>
    </footer>
  );
}
...
function FloatingBottomNav() {
  return (
    ...
    >
      ...
      <Link to="/" className="float-leaf" aria-label="CannaPlug home">
