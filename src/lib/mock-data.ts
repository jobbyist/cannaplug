...
export const products: Product[] = [
  {
    ...
    unit: "3.5g",
    badge: "Premium",
    description: "A dessert-leaning hybrid with sweet citrus notes and a relaxed, euphoric finish.",
    is_active: true,
    in_stock: true,
    sort_order: 1,
    image: productImage,
  },
  {
    ...
    unit: "3.5g",
    badge: "Best seller",
    description: "Deep berry aroma with a slow, grounding body effect. A house favourite.",
    is_active: true,
    in_stock: true,
    sort_order: 2,
    image: productImage,
  },
  {
    ...
    unit: "3.5g",
    badge: null,
    description: "Bright, uplifting and energising — a clean daytime strain.",
    is_active: true,
    in_stock: true,
    sort_order: 3,
    image: productImage,
  ...
  {
    id: "p4",
    slug: "mixed-flavour-gummies",
    name: "Mixed Flavour Gummies",
    category: "Edibles",
    subcategory: "10 pack",
    strain_type: "Hybrid",
    price_rand: 300,
    unit: "10 pack",
    badge: "Popular",
    description: "10mg per gummy, lab-dosed for consistency. Assorted fruit flavours.",
    is_active: true,
    in_stock: true,
    sort_order: 4,
    image: productImage,
  },
  {
    ...
    category: "Edibles",
    subcategory: "Infused chocolate",
    strain_type: null,
    price_rand: 260,
    unit: "8 squares",
    badge: null,
    description: "70% dark chocolate, evenly dosed and easy to microdose.",
    is_active: true,
    in_stock: false,
    sort_order: 5,
    image: productImage,
  ...
  {
    id: "p6",
    slug: "raw-distillate-cart",
    name: "Raw Distillate Cart",
    category: "Vapes",
    subcategory: "1g cartridge",
    strain_type: "Sativa",
    price_rand: 420,
    unit: "1g",
    badge: "Lab tested",
    description: "Clean, potent distillate in a standard 510-thread cartridge.",
    is_active: true,
    in_stock: true,
    sort_order: 6,
    image: productImage,
  },
  {
    ...
    unit: "1g",
    badge: "New",
    description: "Full-spectrum live resin for a richer flavour and effect profile.",
    is_active: true,
    in_stock: true,
    sort_order: 7,
    image: productImage,
  },
  {
    ...
    unit: "1g",
    badge: null,
    description: "High-purity shatter with a smooth, glassy break.",
    is_active: true,
    in_stock: false,
    sort_order: 8,
    image: productImage,
  ...
  {
    id: "p9",
    slug: "indoor-pre-rolls",
    name: "Indoor Pre-Rolls",
    category: "Flower",
    ...
    unit: "5 pack",
    badge: null,
    description: "Five ready-to-go indoor-grown pre-rolls in a reusable CannaPlug tube.",
    is_active: true,
    in_stock: true,
    sort_order: 9,
    image: productImage,
  ...
  {
    id: "p10",
    slug: "cannaplug-grinder",
    name: "CannaPlug Grinder",
    ...
    unit: "1 unit",
    badge: "New",
    description: "4-piece aircraft-grade aluminium grinder with pollen catcher.",
    is_active: true,
    in_stock: true,
    sort_order: 10,
    image: categoryImage,
  },
  {
    ...
    unit: "1 unit",
    badge: null,
    description: "Tempered glass tray with raised edges for a tidy roll.",
    is_active: true,
    in_stock: true,
    sort_order: 11,
    image: categoryImage,
  },
  {
    ...
    unit: "5ml",
    badge: null,
    description: "Food-grade terpene blend for flavour and aroma layering.",
    is_active: true,
    in_stock: false,
    sort_order: 12,
    image: productImage,
...
export const mockOrders: MockOrder[] = [
  {
    id: "o1",
    order_number: "RCP-10423",
    status: "Delivered",
    total_rand: 1020,
    created_at: "2026-04-19T10:00:00Z",
    contact_name: "Michael Barck",
    items: [
      { product_name: "Gelato 33", quantity: 2, unit_price_rand: 350 },
      { product_name: "Anti-Odour Jar", quantity: 1, unit_price_rand: 320 },
    ],
  },
  {
    id: "o2",
    order_number: "RCR-10421",
    status: "Delivered",
    total_rand: 640,
